...
import in.co.retail.applibrary.searchview.utils.AnimationUtil;
...
public class MaterialSearchView extends FrameLayout implements Filter.FilterListener {
     ...
     *
     * @param jArr JSONArray of data//suggestions array of suggestions
     */
    public void setSuggestions(JSONArray jArr) {
        if (jArr != null && jArr.length() > 0) {
            mTintView.setVisibility(VISIBLE);
            final SearchAdapter adapter = new SearchAdapter(mContext, jArr, suggestionIcon);
            setAdapter(adapter);
            ...
            setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    setQueryFetch(adapter.getItem(position).toString(), false);
                }
            });
        } else {
    ...
    public void setQueryFetch(CharSequence query, boolean submit)
    {
        mOnQueryChangeListener.onQueryTextClick(query.toString());
    }
    ...
    public interface OnQueryTextListener {
        ...
        boolean onQueryTextClick(String text);
    }
